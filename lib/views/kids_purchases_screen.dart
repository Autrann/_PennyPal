...
class KidsPurchasesScreen extends StatefulWidget {
  final int userId;

  KidsPurchasesScreen({required this.userId});

  @override
  _KidsPurchasesScreenState createState() => _KidsPurchasesScreenState();
}

class _KidsPurchasesScreenState extends State<KidsPurchasesScreen> {
